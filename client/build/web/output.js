...
if (typeof dto === 'undefined') {
  throw new Error("Error loading module 'output'. Its dependency 'dto' was not found. Please, check whether 'dto' is loaded prior to 'output'.");
}
var output = function (_, Kotlin, $module$dto) {
  'use strict';
  var Command = $module$dto.Command;
  ...
  Object.defineProperty(_, 'commandLOL', {
    get: function () {
      return commandLOL;
    }
  });
